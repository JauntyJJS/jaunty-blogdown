...
In general, they are in the form {acyl_class} {total_C}:{total_DB} [NL-{measured_C}:{measured_DB}]. We need to transform into the form {acyl_class} {measured_C}:{measured_DB}\_{remaining_C}:{remaining_DB} where {remaining_C} is {total_C - measured_C} and {remaining_DB} is {total_DB - measured_DB}
