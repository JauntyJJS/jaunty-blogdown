...
![MoSBi_unzip](images/LINEX_unzip.png)

In my example, I choose to extract it on the D drive.

![MoSBi_destination](images/LINEX_destination.png)

![MoSBi_in_D_drive](images/LINEX_in_D_drive.png)
