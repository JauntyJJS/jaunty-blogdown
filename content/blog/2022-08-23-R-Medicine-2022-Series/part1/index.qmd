...
![Command Prompt Option](commandline_option.jpg){fig-align="center" fig-alt="Figure showing how to set the terminal to use Windows 10 command line"}

![Command Line Results](commandline.jpg){fig-align="center" fig-alt="Figure showing the command quarto works in Windows 10 command line"}

![PowerShell Option](powershell_option.jpg){fig-align="center" fig-alt="Figure showing how to set the terminal to use Windows 10 PowerShell"}

![PowerShell Results](powershell.jpg){fig-align="center" fig-alt="Figure showing the command quarto works in Windows 10 PowerShell"}

On the other hand, Git Bash uses `quarto.cmd` for my computer.

![Git Bash Option](gitbash_option.jpg){fig-align="center" fig-alt="Figure showing how to set the terminal to use Windows 10 Git Bash"}

![Git Bash Results](gitbash.jpg){fig-align="center" fig-alt="Figure showing the command quarto.cmd works in Windows 10 Git Bash"}
...
![](sessioninfo.jpg){fig-align="center" fig-alt="Picture showing a Github Issue opened by Tom Mock, requesting for the Quarto version used in an R session to be in the session info."}

Do give your support.

![](support.jpg){fig-align="center" fig-alt="Figure asking others to support the above figure GitHub issue."}
