...
![Session Info](sessioninfo.jpg){fig-align="center" fig-alt="Picture showing a Github Issue opened by Tom Mock, requesting for the Quarto version used in an R session to be in the session info."}

Do give your support.

![Session Info](support.jpg){fig-align="center" fig-alt="Figure asking others to support the above figure GitHub issue."}
