...
As such, in 2021, the [SCORE2](https://doi.org/10.1093/eurheartj/ehab309) [@SCORE2] project was launched using 45 more recent cohorts from 13 countries to allow the model to recalibrate and expand its prediction to both fatal and non-fatal CVD outcomes. External validation was also done to ensure that the SCORE2 model is reliable.
