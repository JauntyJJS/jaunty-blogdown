...
Using green as the running example, first in excel, extract the hex code say #00B050 for green. Next, use https://www.schemecolor.com/?getcolor={hex code} (<https://www.schemecolor.com/sample?getcolor=00B050> in our running example) to find out what the Hex8 code is for green.   

![](images/green_hex_code.png){fig-alt="Figure showing how to get the Hex code."}

As such, we can identify the `local format id` accordingly with the black and green Hex8 code, #FF000000 and #FF00B050 respectively.
